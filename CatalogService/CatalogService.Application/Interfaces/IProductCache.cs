...
/// <see cref="Queries.GetProductByIdQuery"/> returns. Caching the projection rather than the
/// EF entity means no change-tracking footguns on deserialize and the cached unit matches the
/// endpoint output exactly.
/// </para>
/// <para>
