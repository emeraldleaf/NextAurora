...
using EventLogAlias = ShippingService.Infrastructure.EventLog.EventLogEntry;
...
public static class AdminEventEndpoints
{
    public static void MapAdminEventEndpoints(this WebApplication app)
    {
        ...
        group.MapPost("/{eventId:guid}/replay", async (Guid eventId, ShippingDbContext db, ServiceBusClient sbClient) =>
        {
        ...
        group.MapPost("/replay-chain", async (string correlationId, ShippingDbContext db, ServiceBusClient sbClient) =>
        {
