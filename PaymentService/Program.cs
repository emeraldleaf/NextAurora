...
// one container per service). **If/when this service scales to 2+ replicas** for resilience, the
// in-memory counter silently multiplies the effective limit by N (each replica enforces
// its own; a client hitting any replica gets a fresh 10-allowance). Fix at that point:
