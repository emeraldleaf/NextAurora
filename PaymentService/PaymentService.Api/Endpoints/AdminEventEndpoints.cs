...
using EventLogAlias = PaymentService.Infrastructure.EventLog.EventLogEntry;
...
public static class AdminEventEndpoints
{
    public static void MapAdminEventEndpoints(this WebApplication app)
    {
        ...
        group.MapPost("/{eventId:guid}/replay", async (Guid eventId, PaymentDbContext db, ServiceBusClient sbClient) =>
        {
        ...
        group.MapPost("/replay-chain", async (string correlationId, PaymentDbContext db, ServiceBusClient sbClient) =>
        {
