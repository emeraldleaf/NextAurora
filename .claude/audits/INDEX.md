...
| 2026-06-12 | [.NET Microservices Guide — What To Do and What To Avoid](2026-06-12-dotnet-microservices-do-avoid.md) (Real World .NET) | ✅ Paywall-limited (intro only); all four visible theses encoded more rigorously (monolith-first warning answered in project-decisions §2; communication/consistency/ops engineered, not admonished) | No action |
